<%-- 
    Document   : funcionarioAdd
    Created on : 16/09/2017, 23:45:42
    Author     : Anderson2
--%>
    ...
    <div class="col-lg-10">
        <div class="panel panel-green">
            ...
            <div class="panel-body">
                ...
                <form action="Home?ac=funcionario_save" method="POST">
                    <div class="col-lg-10">
                        ...
                        <div class="form-group">
                            <a class="btn btn-info" href="Home?ac=funcionario_index">Voltar</a>
